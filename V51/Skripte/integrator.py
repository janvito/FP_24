...
# Load data
f, U_i, U_0 = np.genfromtxt("../Daten/integrator.csv", delimiter=",", unpack=True, skip_header=1)
...
plt.legend()
plt.savefig("../Ressourcen/integrator_plot.png")
plt.show()
