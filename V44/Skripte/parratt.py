...
theta, counts = theta[15:80], counts[15:80]
...
plt.plot(theta,np.exp(counts),label=r"Gemessene Reflexivität")
plt.plot(theta,np.exp(parratt(theta,*final_guess1)),label=r"Parratt-Reflexivität")
plt.tight_layout()
plt.show()
