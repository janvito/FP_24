...
Hergeleitet mithilfe der Maxwell-Gleichungen an Grenzschichten ergeben sich für das Amplitudenverhältnisses von einfallender und reflektierter Welle die Formeln
\begin{align}
...
\begin{align}
  r = r_\text{s,p} = \frac{\alpha-\alpha_\text{t}{\alpha+\alpha_\text{t}}}
\end{align}
